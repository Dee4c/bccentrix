...
if (isset($_POST['edit_comment'])) {
    ...
    $stmt = $conn->prepare("SELECT user_id FROM bsis_comment WHERE bsis_comment_id = ?");
    ...
    $sql = "SELECT content FROM bsis_comment WHERE bsis_comment_id = $comment_id";
