...
if (isset($_POST['edit_comment'])) {
    ...
    $stmt = $conn->prepare("SELECT user_id FROM foods_comment WHERE foods_comment_id = ?");
    ...
    $stmt = $conn->prepare("UPDATE foods_comment SET content = ? WHERE foods_comment_id = ?");
    ...
    $sql = "SELECT content FROM foods_comment WHERE foods_comment_id = $comment_id";
