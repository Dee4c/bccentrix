...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['id'])) {
        ...
        if ($existing_reactions > 0) {
            ...
            $delete_sql = "DELETE FROM bsa_reaction_logs WHERE bsa_post_id = ? AND user_id = ?";
            ...
            $insert_sql = "INSERT INTO bsa_reaction_logs (bsa_post_id, user_id, reaction_type) VALUES (?, ?, ?)";
