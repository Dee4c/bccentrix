...
if (isset($_POST['post'])) {
    ...
    if (!empty($post_content)) {
        ...
        $stmt = $conn->prepare("INSERT INTO drygoods_post (content, image, date_created, user_id, approved) VALUES (?, ?, NOW(), ?, 0)");
        ...
        if ($stmt->execute()) {
            ...
            echo 'window.location.href = "drygoods_announcement.php";';
            echo '</script>';
            exit;
        } else {
