...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['admin_id'])) {
        ...
        if ($existing_reactions > 0) {
            ...
            $delete_sql = "DELETE FROM laf_reaction_logs WHERE laf_post_id = ? AND user_id = ?";
            ...
            $insert_sql = "INSERT INTO laf_reaction_logs (laf_post_id, user_id, reaction_type) VALUES (?, ?, ?)";
