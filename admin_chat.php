  ...
  <div class="">
    <section class="chat-area">
      <header>
        ...
        ?>
        <a href="admin_chatpage.php" class="back-icon"><i class="fas fa-arrow-left"></i></a>
...
sendBtn.onclick = ()=>{
    ...
    xhr.open("POST", "admin_chatinsert-chat.php", true);
    xhr.onload = ()=>{
...
setInterval(() =>{
    let xhr = new XMLHttpRequest();
    xhr.open("POST", "admin_chatget-chat.php", true);
    xhr.onload = ()=>{
      if(xhr.readyState === XMLHttpRequest.DONE){
          if(xhr.status === 200){
