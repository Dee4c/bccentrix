...
if (isset($_POST['edit_comment'])) {
    ...
    $stmt = $conn->prepare("SELECT user_id FROM drygoods_comment WHERE drygoods_comment_id = ?");
    ...
    $stmt = $conn->prepare("UPDATE drygoods_comment SET content = ? WHERE drygoods_comment_id = ?");
    ...
    $sql = "SELECT content FROM drygoods_comment WHERE drygoods_comment_id = $comment_id";
