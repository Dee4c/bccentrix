...
function sendMessage(message) {
    ...
    xhr.open("POST", "admin_sent_chat_message.php", true);
...
function retrieveAndDisplayChatMessages() {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open("GET", `admin_get_chat_messages.php?group_id=${groupId}`, true);
    xhr.onload = function () {
        if (xhr.status == 200) {
            try {
...
function editMessage(messageId, newMessage) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open("POST", "admin_edit_chat_message.php", true); // Create an edit_chat_message.php file for handling edits
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.onload = function () {
        if (xhr.status == 200) {
...
function deleteMessage(messageId) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open("POST", "admin_delete_chat_message.php", true); // Create a delete_chat_message.php file for handling deletions
    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhr.onload = function () {
        if (xhr.status == 200) {
