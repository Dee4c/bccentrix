...
if (isset($_POST['edit_comment'])) {
    ...
    $stmt = $conn->prepare("SELECT user_id FROM bsa_comment WHERE bsa_comment_id = ?");
    ...
    $sql = "SELECT content FROM bsa_comment WHERE bsa_comment_id = $comment_id";
