...
<head>
    ...
    <link rel="stylesheet" href="postmainlink/bootstrap.min.css">
    ...
    <style>
        ...
        body{
            background:linear-gradient(to right, #70C1B3, #247B9F);
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="admin_drygoods_post.php" onsubmit="return validatePostContent()" enctype="multipart/form-data">
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        if ($user_id == $row['user_id']) {
            ...
            echo '<li><a href="admin_drygoods_delete_post.php?post_id=' . $post_id . '" onclick="return confirm(\'Are you sure you want to delete this post?\')"><i class="fas fa-trash"></i> Delete</a></li>';
        ...
        $comments_result = $conn->query($comments_sql);
         ...
         echo '<form method="post" action="admin_drygoods_comment.php">';
                ...
                ?>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a href="admin_drygoods_delete_comment.php?comment_id=<?php echo $comment_id; ?>" onclick="return confirm('Are you sure you want to delete this comment?')"><i class="fas fa-trash"></i> Delete</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <!-- Add this HTML form to your page -->
                                    <form method="post" action="admin_drygoods_edit_comment.php">
...
<div class="modal fade" id="editPostModal" tabindex="-1" role="dialog" aria-labelledby="editPostModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="admin_drygoods_edit_post.php" id="editPostForm">
                    <div class="form-group">
...
<script>
     ...
     function updateReactionCount(postId) {
        $.ajax({
            type: "GET",
            url: "admin_drygoods_fetch_reaction_count.php",
            data: {
                post_id: postId
            },
   ...
   $(".reaction-button").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "admin_drygoods_record_reaction.php",
            data: {
                post_id: postId,
                reaction_type: "heart"
            },
