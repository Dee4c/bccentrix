...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['id'])) {
        ...
        if ($existing_reactions > 0) {
            ...
            $delete_sql = "DELETE FROM drygoods_reaction_logs WHERE drygoods_post_id = ? AND user_id = ?";
            ...
            $insert_sql = "INSERT INTO drygoods_reaction_logs (drygoods_post_id, user_id, reaction_type) VALUES (?, ?, ?)";
