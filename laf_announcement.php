    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="laf_post.php" onsubmit="return validatePostContent()" enctype="multipart/form-data">
...
<div class="panel laf-panelpost" style=" ">
<div id="whats-on-your-mind-container">
    ...
    <img class="img-circle" style="position: absolute; width: 40px; height: 40px; object-fit:cover; margin-left:20px; margin-top: 5px; margin-right: 20px; float:left;" src= "<?php echo $_SESSION['profile_picture'] ?>" alt="User Image">
        <textarea class="form-control laftext-comment" style="" name="post_content" id="post_content_whats_on_your_mind" placeholder="What's the update?"></textarea>
        </div>
    </div>
      <div class="laf-footerpost" style="">
    <div  data-toggle="modal" data-target="#uploadModal" class="upload" style=" display: flex; align-items: center; text-decoration: none; border-radius: 10px;">
      <img  class="lafphoto-icon" src="uploads/photos.png" > 
      <span>photos</span>
    </div>
</div> 
...
$sql = "SELECT laf_post.*, concat(user.fname,' ',user.lname) as name,user.image_path  FROM laf_post 
        LEFT JOIN user ON laf_post.user_id = user.user_id
        ORDER BY date_created DESC";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $post_id = $row['laf_post_id'];
        ...
        $imagePath = $row['image_path'];
         ...
         echo '<div class="panel panel-default custom-panel laf-rowpost">';
        ...
        if ($user_id == $row['user_id']) {
            ...
            echo '<li><a href="laf_delete_post.php?post_id=' . $post_id . '" onclick="return confirm(\'Are you sure you want to delete this post?\')"><i class="fas fa-trash"></i> Delete</a></li>';
        ...
        if (!empty($row['image'])) {
            ...
            echo '<img clas="lafpost-image" src="' . $imagePath . '" alt="Image" style="">'; // Adjust max-height and max-width as needed
        }
        ...
        if (isset($_SESSION['id'])) {
            ...
            $check_sql = "SELECT COUNT(*) FROM laf_reaction_logs WHERE laf_post_id = ? AND user_id = ?";
        ...
        // laferate the heart button HTML with the appropriate CSS class
        // laferate the heart button HTML with the appropriate CSS class
        ...
        $comment_count_sql = "SELECT COUNT(*) FROM laf_comment WHERE laf_post_id = ?";
        ...
        $comments_sql = "SELECT laf_comment.*, concat(user.fname,' ',user.lname) as name,user.image_path FROM laf_comment
        LEFT JOIN user ON laf_comment.user_id = user.user_id
        WHERE laf_comment.laf_post_id = $post_id
        ORDER BY date_posted ASC";
        $comments_result = $conn->query($comments_sql);

         // Add a form for adding comments to this post

        echo '<form method="post" action="laf_comment.php">';
        ...
        if ($comments_result->num_rows > 0) {
            ...
            while ($comment_row = $comments_result->fetch_assoc()) {
                ...
                $comment_id = $comment_row['laf_comment_id']; // Assuming you have a unique comment_id
                ...
                if ($user_id == $comment_user_id) {
                    ...
                    // echo '</div>';
                    ?>
                    <div class="dropdown lafcomment-btn" style="">
                    <button class="btn btn-default dropdown-toggle " type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a href="laf_delete_comment.php?comment_id=<?php echo $comment_id; ?>" onclick="return confirm('Are you sure you want to delete this comment?')"><i class="fas fa-trash"></i> Delete</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <!-- Add this HTML form to your page -->
                                    <form method="post" action="laf_edit_comment.php">
...
<div class="modal fade" id="editPostModal" tabindex="-1" role="dialog" aria-labelledby="editPostModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="laf_edit_post.php" id="editPostForm">
                    <div class="form-group">
...
<script>
     ...
     function updateReactionCount(postId) {
        $.ajax({
            type: "GET",
            url: "laf_fetch_reaction_count.php",
            data: {
                post_id: postId
            },
