...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['admin_id'])) {
        ...
        if ($existing_reactions > 0) {
            ...
            $delete_sql = "DELETE FROM gen_reaction_logs WHERE gen_post_id = ? AND user_id = ?";
            ...
            $insert_sql = "INSERT INTO gen_reaction_logs (gen_post_id, user_id, reaction_type) VALUES (?, ?, ?)";
