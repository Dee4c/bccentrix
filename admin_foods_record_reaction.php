...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['admin_id'])) {
        ...
        if ($existing_reactions > 0) {
            ...
            $delete_sql = "DELETE FROM foods_reaction_logs WHERE foods_post_id = ? AND user_id = ?";
            ...
            $insert_sql = "INSERT INTO foods_reaction_logs (foods_post_id, user_id, reaction_type) VALUES (?, ?, ?)";
