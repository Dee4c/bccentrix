...
if (isset($_POST['edit_comment'])) {
    ...
    $stmt = $conn->prepare("SELECT user_id FROM bscrim_comment WHERE bscrim_comment_id = ?");
    ...
    $sql = "SELECT content FROM bscrim_comment WHERE bscrim_comment_id = $comment_id";
