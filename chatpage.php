        ...
        <div class="chat-container">
            ...
            <aside class="chat-sidebar">
                ...
                <ul class="chat-sidebar-menu">
                    ...
                    <li><a href="announcement.php" data-title="Home"><i class="ri-home-line"></i></a></li>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"/>
            ...
            <div class="chat-content">
                ...
                <div class="content-sidebar">
                    ...
                    <a style="text-decoration: none; font-size:25px; color: black; float:right; margin-right:10px;"  href="announcement.php" data-title="Home"><i class="ri-home-line"></i></a></div>
                    <div class="wrapper">
                    <section class="users">
                    <div class="search">
...
<script>
        ...
        xhr.open("POST", "chatsearch.php", true);
        xhr.onload = ()=>{
        ...
        setInterval(() =>{
        let xhr = new XMLHttpRequest();
        xhr.open("GET", "chatusers.php", true);
        xhr.onload = ()=>{
            if(xhr.readyState === XMLHttpRequest.DONE){
                if(xhr.status === 200){
                let data = xhr.response;
