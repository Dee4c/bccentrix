...
<body>
    ...
    <div class="sidebar">
        <span class="group-chats">
            <a class="home-icon" href="adminannouncement.php"><i class="fas fa-home"></i></a>
            ...
            if ($userGroupsResult && mysqli_num_rows($userGroupsResult) > 0) {
                ...
                while ($groupRow = mysqli_fetch_assoc($userGroupsResult)) {
                    ...
                    echo '<a href="admin_joined_group.php?id=' . $groupId . '&user=' . urlencode($userName) . '">';
                    echo $groupName;
                    echo '</a>';
                }
    ...
    <div id="joinGroupModal" class="modal">
        <div class="agc-button">
            <form action="admin_gc_function.php" method="post">
    ...
    <div id="createGroupModal" class="modal">
        <div class="agc-button">
            <form action="admin_create_gc.php" method="post">
                ...
                <a href="admin_grouppage.php" class="btn btn-primary">Go back</a>
            </form>
        </div>
    </div>
    ...
    <!-- <div class="no-group-container" id="noGroupContainer">
        ...
        <div class="no-group-text">Select Group and View Conversation</div>
    </div> -->
    ...
    <script>
        ...
        function updateNoGroupContainerVisibility() {
            ...
            if (window.location.pathname.indexOf("admin_joined_group.php") > -1) {
