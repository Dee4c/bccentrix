...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['id'])) {
        ...
        if ($existing_reactions > 0) {
            ...
            $delete_sql = "DELETE FROM bscrim_reaction_logs WHERE bscrim_post_id = ? AND user_id = ?";
            ...
            $insert_sql = "INSERT INTO bscrim_reaction_logs (bscrim_post_id, user_id, reaction_type) VALUES (?, ?, ?)";
